...
import com.HKSHOPU.hk.ui.main.seller.product.adapter.ProductCategoryItemAdapter
import com.HKSHOPU.hk.ui.main.seller.product.adapter.ProductSubCategoryItemAdapter
                ...
                try {
                    ...
                    if (ret_val.equals("已取得產品分類清單!")) {
                        ...
                        runOnUiThread {
                            ...
                            binding.rViewCategoryItem.layoutManager = LinearLayoutManager(this@AddProductCategoryActivity, LinearLayoutManager.VERTICAL, false)
            ...
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    if (ret_val.equals("已取得產品子分類清單!")) {
                        ...
                        //預設篩選product_category_list為 0 的子項目
                        ...
                        runOnUiThread {
                            ...
                            binding.rViewCategorySubItem.layoutManager = GridLayoutManager(this@AddProductCategoryActivity, 3)
