        ...
        val web = Web(object : WebListener {
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    Log.d("doShopFaceBookOnOff", "JSONException: ${e.toString()}")
                } catch (e: IOException) {
                    e.printStackTrace()
                    Log.d("doShopFaceBookOnOff", "IOException: ${e.toString()}")
                }
            }

            override fun onErrorResponse(ErrorResponse: IOException?) {
                Log.d("doShopFaceBookOnOff", "ErrorResponse: ${ErrorResponse.toString()}")
            }
        })
