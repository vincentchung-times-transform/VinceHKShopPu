...
class ProductCategorySearchItemAdapter: RecyclerView.Adapter<ProductCategorySearchItemAdapter.mViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: mViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            RxBus.getInstance().post(EventProductCatSelectedToSearch(selected_item_id, c_product_category_selected))
            if(position != last_position) {
