        ...
        val web = Web(object : WebListener {
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    Log.d("AddressEditActivity", "JSONException" + e.toString())
                    runOnUiThread {
                        binding.progressBarBuildAccountAddressEditing.visibility = View.GONE
                        binding.ivLoadingBackgroundBuildAccountAddressEditing.visibility = View.GONE
                    }
                    ...
                    e.printStackTrace()
                    Log.d("AddressEditActivity", "IOException" + e.toString())
                    runOnUiThread {
                        binding.progressBarBuildAccountAddressEditing.visibility = View.GONE
                        binding.ivLoadingBackgroundBuildAccountAddressEditing.visibility = View.GONE
                    }
            ...
            override fun onErrorResponse(ErrorResponse: IOException?) {
                Log.d("AddressEditActivity", "ErrorResponse" + ErrorResponse.toString())
                runOnUiThread {
                    binding.progressBarBuildAccountAddressEditing.visibility = View.GONE
                    binding.ivLoadingBackgroundBuildAccountAddressEditing.visibility = View.GONE
                }
