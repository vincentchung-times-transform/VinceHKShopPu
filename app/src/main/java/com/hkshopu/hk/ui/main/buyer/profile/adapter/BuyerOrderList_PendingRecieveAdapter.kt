...
class BuyerOrderList_PendingRecieveAdapter(var fragment: Fragment) : RecyclerView.Adapter<BuyerOrderList_PendingRecieveAdapter.BuyerPendingRecieveLinearHolder>(){
...
//        }
        viewHolder.itemView.setOnClickListener {
            val intent = Intent(viewHolder.itemView.context, BuyerPurchaseListRecieveActivity::class.java)
            val bundle = Bundle()
