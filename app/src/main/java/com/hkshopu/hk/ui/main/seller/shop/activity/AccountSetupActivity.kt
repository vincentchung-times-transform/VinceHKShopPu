...
class AccountSetupActivity : BaseActivity() {
    ...
    private fun initClick() {
        ...
        binding.layoutShopInfo.setOnClickListener {
            val intent = Intent(this, com.HKSHOPU.hk.ui.main.seller.shop.activity.ShopInfoModifyActivity::class.java)
            startActivity(intent)
        }

        binding.layoutShopAddress.setOnClickListener {
            val intent = Intent(this, com.HKSHOPU.hk.ui.main.seller.shop.activity.ShopAddressListActivity::class.java)
            startActivity(intent)
        }

        binding.layoutShopBankaccount.setOnClickListener {
            val intent = Intent(this, com.HKSHOPU.hk.ui.main.seller.shop.activity.BankListActivity::class.java)
            startActivity(intent)
        }
