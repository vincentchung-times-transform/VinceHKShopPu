...
class AddShopBriefActivity : BaseActivity() {
    ...
    val shopId = mmkvWithID("http").getString("ShopId","").toString()
...
//        shop_Des = intent.getBundleExtra("bundle")!!.getString("shop_des","")
    ...
    private fun initView(){
        ...
        binding.etAddshopbrief.doAfterTextChanged {
            var temp = ""
            temp = binding.etAddshopbrief.text.toString().replace("\n", "", false)
...
//        })
    ...
    private fun getShopBrief(url: String) {
        ...
        Log.d("getShopBrief", "返回資料 Url：" + url)
        val web = Web(object : WebListener {
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    Log.d("getShopBrief_errorMesssage", "JSONException: ${e.toString()}")
                    runOnUiThread {
                        binding.progressBar.visibility = View.GONE
                        binding.imgViewLoadingBackground.visibility = View.GONE
                    }
                    ...
                    e.printStackTrace()
                    Log.d("getShopBrief_errorMesssage", "IOException: ${e.toString()}")
                    runOnUiThread {
                        binding.progressBar.visibility = View.GONE
                        binding.imgViewLoadingBackground.visibility = View.GONE
                    }
            ...
            override fun onErrorResponse(ErrorResponse: IOException?) {
                Log.d("getShopBrief_errorMesssage", "ErrorResponse: ${ErrorResponse.toString()}")
                runOnUiThread {
                    binding.progressBar.visibility = View.GONE
                    binding.imgViewLoadingBackground.visibility = View.GONE
                }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK && requestCode == pickImage) {
            ...
            try {
                ...
                isSelectImage = false
                //handle exception
                Log.d("onActivityResult_errorMesssage", "Exception: ${e.toString()}")
            }
        }
    }
        ...
        val web = Web(object : WebListener {
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    val ret_val = json.get("ret_val")
                    val status = json.get("status")
                    Log.d("doShopBgUpdate", "返回資料 resStr：" + resStr)
                    ...
                    Log.d("doShopBgUpdate_errorMesssage", "JSONException: ${e.toString()}")
                    runOnUiThread {
                        binding.progressBar.visibility = View.GONE
                        binding.imgViewLoadingBackground.visibility = View.GONE
                    }
                    ...
                    e.printStackTrace()
                    Log.d("doShopBgUpdate_errorMesssage", "IOException: ${e.toString()}")
                    runOnUiThread {
                        binding.progressBar.visibility = View.GONE
                        binding.imgViewLoadingBackground.visibility = View.GONE
                    }
            ...
            override fun onErrorResponse(ErrorResponse: IOException?) {
                Log.d("doShopBgUpdate_errorMesssage", "onErrorResponse: ${ErrorResponse.toString()}")
                runOnUiThread {
                    binding.progressBar.visibility = View.GONE
                    binding.imgViewLoadingBackground.visibility = View.GONE
                }
        ...
        val web = Web(object : WebListener {
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    val ret_val = json.get("ret_val")
                    val status = json.get("status")
                    Log.d("doShopDesUpdate", "返回資料 resStr：" + resStr)
                    Log.d("doShopDesUpdate", "返回資料 ret_val：" + json.get("ret_val"))
                    ...
                    Log.d("doShopDesUpdate_errorMesssage", "JSONException: ${e.toString()}")
                    runOnUiThread {
                        binding.progressBar.visibility = View.GONE
                        binding.imgViewLoadingBackground.visibility = View.GONE
                    }
                    ...
                    e.printStackTrace()
                    Log.d("doShopDesUpdate_errorMesssage", "IOException: ${e.toString()}")
                    runOnUiThread {
                        binding.progressBar.visibility = View.GONE
                        binding.imgViewLoadingBackground.visibility = View.GONE
                    }
            ...
            override fun onErrorResponse(ErrorResponse: IOException?) {
                Log.d("doShopDesUpdate_errorMesssage", "ErrorResponse: ${ErrorResponse.toString()}")
                runOnUiThread {
                    binding.progressBar.visibility = View.GONE
                    binding.imgViewLoadingBackground.visibility = View.GONE
                }
