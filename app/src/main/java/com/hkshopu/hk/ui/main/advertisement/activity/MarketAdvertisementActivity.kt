...
import com.HKSHOPU.hk.databinding.ActivityMarketAdvertisementBinding
...
class MarketAdvertisementActivity : BaseActivity() {
    private lateinit var binding: ActivityMarketAdvertisementBinding
    var MMKV_user_id = MMKV.mmkvWithID("http").getString("UserId", "").toString()
    var shop_id = ""

    private val adapter_product = AdvertisementAdapter("product_market")
    private val adapter_store = AdvertisementAdapter("store_market")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMarketAdvertisementBinding.inflate(layoutInflater)
        ...
        doGetMarketAdForProduct(MMKV_user_id, "product")
        doGetMarketAdForShop(MMKV_user_id, "shop")
    ...
    private fun initClick() {
        ...
        binding.layoutAddProductAd.setOnClickListener {
            val intent = Intent(this, AddEditProductMarketAdvertisementActivity::class.java)
            var bundle = Bundle()
        ...
        binding.layoutAddStoreAd.setOnClickListener {
            val intent = Intent(this, AddEditStoreMarketAdvertisementActivity::class.java)
            var bundle = Bundle()
            bundle.putString("shopId", shop_id)
            bundle.putString("mode", "add")
            intent.putExtra("bundle", bundle)
...
//                binding.ivStoreDropDown.setRotation(180.0F)
    ...
    private fun doGetMarketAdForProduct(user_id: String, ad_type: String) {
        binding.progressBar.visibility = View.VISIBLE
        binding.imgViewLoadingBackground.visibility = View.VISIBLE

        var url = ApiConstants.API_HOST + "user/${user_id}/adSetting/store/${ad_type}/"
        val web = Web(object : WebListener {
            ...
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    Log.d("doGetMarketAdForProduct", "返回資料 resStr：" + resStr)
                    Log.d("doGetMarketAdForProduct", "返回資料 ret_val：" + ret_val)

                    val jsonObject: JSONObject = json.getJSONObject("data")
                    Log.d("doGetMarketAdForProduct", "返回資料 Object：" + jsonObject.toString())
                    ...
                    if(JSONArray.length()>0){
                        ...
                        runOnUiThread {
                            renderAdType("product_market", list.get(0), list.get(0).status)

                            val layoutManager = LinearLayoutManager(this@MarketAdvertisementActivity)
    ...
    private fun doGetMarketAdForShop(user_id: String, ad_type: String) {
        Log.d("doGetMarketAdForShop", "user_id: ${user_id}, ad_type: ${ad_type} ")
        binding.progressBar.visibility = View.VISIBLE
        binding.imgViewLoadingBackground.visibility = View.VISIBLE
        ...
        val web = Web(object : WebListener {
            ...
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    val json = JSONObject(resStr)
                    val ret_val = json.get("ret_val")
                    Log.d("doGetMarketAdForShop", "返回資料 resStr：" + resStr)
                    Log.d("doGetMarketAdForShop", "返回資料 ret_val：" + ret_val)

                    val jsonObject: JSONObject = json.getJSONObject("data")
                    Log.d("doGetMarketAdForShop", "返回資料 Object：" + jsonObject.toString())
                    ...
                    if(JSONArray.length()>0){
                        ...
                        runOnUiThread {
                            renderAdType("store_market", list.get(0), list.get(0).status)
            ...
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    if (ret_val.equals("廣告狀態更新成功")) {
                        ...
                        runOnUiThread {
                            Toast.makeText(this@MarketAdvertisementActivity, ret_val.toString(), Toast.LENGTH_SHORT)
                                .show()
                        }
                        Log.d("doUpdateAdStatus", "ret_val: ${ret_val.toString()}")
                    }
                    ...
                    runOnUiThread {
                        Toast.makeText(this@MarketAdvertisementActivity, "網路異常", Toast.LENGTH_SHORT).show()
