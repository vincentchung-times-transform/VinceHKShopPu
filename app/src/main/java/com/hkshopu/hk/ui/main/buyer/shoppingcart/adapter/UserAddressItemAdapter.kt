...
//            intentClick?.invoke(id)
            RxBus.getInstance().post(EventUpdateShoppingCartItemForConfirmed( id.toString(), name.toString(), phone.toString(), address.toString(), shoppingCartShopId.toString(), specId_json, "single"))
            activity.finish()
