        ...
        val web = Web(object : WebListener {
            override fun onResponse(response: Response) {
                ...
                try {
                    ...
                    Log.d("doLogin", "返回資料 ret_val：" + ret_val)
                    ...
                    Log.d("doLogin_errorMessage", "JSONException: ${e.toString()}")
                    runOnUiThread {
                    ...
                    e.printStackTrace()
                    Log.d("doLogin_errorMessage", "IOException: ${e.toString()}")
                    runOnUiThread {
                        Toast.makeText(this@EmailAddBeforeIdentifyingActivity, "網路異常請重新操作", Toast.LENGTH_SHORT).show()
                        binding.progressBarAddEmail.visibility = View.GONE
                        binding.ivLoadingBackgroundAddEmail.visibility = View.GONE
            ...
            override fun onErrorResponse(ErrorResponse: IOException?) {
                Log.d("doLogin_errorMessage", "ErrorResponse: ${ErrorResponse.toString()}")
                runOnUiThread {
                    Toast.makeText(this@EmailAddBeforeIdentifyingActivity, "網路異常請重新操作", Toast.LENGTH_SHORT).show()
                    binding.progressBarAddEmail.visibility = View.GONE
                    binding.ivLoadingBackgroundAddEmail.visibility = View.GONE
