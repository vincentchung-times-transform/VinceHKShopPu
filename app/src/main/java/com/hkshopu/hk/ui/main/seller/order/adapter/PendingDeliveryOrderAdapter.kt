...
import com.HKSHOPU.hk.ui.main.seller.order.activity.ShippingNotificationActivity
import com.HKSHOPU.hk.utils.extension.inflate
import com.HKSHOPU.hk.utils.extension.loadNovelCover
import org.jetbrains.anko.find
import java.util.*

class PendingDeliveryOrderAdapter (): RecyclerView.Adapter<PendingDeliveryOrderAdapter.TopProductLinearHolder>(){
...
//    private var newData: ArrayList<ProductSearchBean> = ArrayList()
    ...
    inner class TopProductLinearHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bindShop(salerSaleListBean : SalerSaleListBean){
            ...
            btn_shipping_notifying.visibility = View.VISIBLE
            btn_buyer_contacting_for_order_small.visibility = View.GONE
            ...
            btn_shipping_notifying.setOnClickListener {
                val intent = Intent(itemView.context, ShippingNotificationActivity::class.java)
                var bundle = Bundle()
                bundle.putString("order_id", salerSaleListBean.order_id)
                intent.putExtra("bundle", bundle)
                itemView.context.startActivity(intent)
