...
class LikeProductForFragmentAdapter(var product_type: String, var activity: FragmentActivity) : RecyclerView.Adapter<LikeProductForFragmentAdapter.ShopInfoLinearHolder>(){
