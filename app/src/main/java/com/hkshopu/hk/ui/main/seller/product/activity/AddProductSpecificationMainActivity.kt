...
import com.HKSHOPU.hk.ui.main.seller.product.adapter.SpecificationFirstSpecsAdapter
import com.HKSHOPU.hk.ui.main.seller.product.adapter.SpecificationSecondSpecsAdapter
...
class AddProductSpecificationMainActivity : BaseActivity() {
    ...
    fun initClick() {
        ...
        binding.btnNextStep.setOnClickListener {
            ...
            val intent = Intent(this, com.HKSHOPU.hk.ui.main.seller.product.activity.AddInventoryAndPriceActivity::class.java)
            startActivity(intent)
            finish()
