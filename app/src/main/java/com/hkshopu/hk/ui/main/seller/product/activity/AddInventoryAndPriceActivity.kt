...
import com.HKSHOPU.hk.ui.main.seller.product.adapter.InventoryAndPriceSpecAdapter
...
//        initSpecDatas()
    ...
    fun initClick() {
        ...
        binding.btnInvenStore.setOnClickListener {
            ...
            val intent = Intent(this, com.HKSHOPU.hk.ui.main.seller.product.activity.AddNewProductActivity::class.java)
            startActivity(intent)
            finish()
