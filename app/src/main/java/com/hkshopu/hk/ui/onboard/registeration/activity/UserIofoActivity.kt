...
class UserIofoActivity : BaseActivity(), TextWatcher {
    ...
    override fun afterTextChanged(s: Editable?) {
        ...
        Log.d("birth_format_checking", "birth: ${birth.toString()}")
            ...
            when (it?.status) {
                Status.Success -> {
                    if (it.ret_val.toString().equals("註冊成功!")) {
                        ...
                        binding.progressBarUserInfo.visibility = View.GONE
                        binding.ivLoadingBackgroundUserInfo.visibility = View.GONE
                    }
...
//                Status.Complete -> disLoading()
    ...
    private fun initClick() {
        ...
        binding.tvSkip.setOnClickListener {
            ...
            binding.ivLoadingBackgroundUserInfo.visibility = View.VISIBLE
    ...
    private fun initEditText() {
        ...
        binding.edtViewBirth.addTextChangedListener(this)
    }
        ...
        if (view.getId() === R.id.show_date_btn) {
            ...
            var dialog = DatePickerDialog(
                ...
                { datePicker, year, month, day ->
                    ...
                    binding.edtViewBirth.setText(changeDateFormat("$day/$month_actual/$year").toString())
                }, mYear, mMonth, mDay
            )
